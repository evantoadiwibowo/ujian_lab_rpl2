...
import com.ssm.evantoadiwibowo.BangunDatar.LayangLayang.KelilingLayangLayang;
import com.ssm.evantoadiwibowo.BangunDatar.LayangLayang.LuasLayangLayang;
...
public class HitungLayangLayangActivity extends AppCompatActivity {
    ...
    private void initial() {
        ...
        getSupportActionBar().setTitle("Layang-Layang (Kite)");
    ...
    public void hitung(View view) {
        ...
        if (buttonText.equals(getString(R.string.hitung_keliling))) {
