...
import com.ssm.evantoadiwibowo.BangunDatar.JajarGenjang.KelilingJajarGenjang;
import com.ssm.evantoadiwibowo.BangunDatar.JajarGenjang.LuasJajarGenjang;
...
public class HitungJajarGenjangActivity extends AppCompatActivity {
    ...
    Button btnHitung;
    Double alas, tinggi, sisiAB, sisiBC, sisiCD, sisiAD;
    ...
    private void initial() {
        ...
        getSupportActionBar().setTitle("Jajar Genjang (Parallelogram)");
    ...
    public void hitung(View view) {
        ...
        if (buttonText == getString(R.string.hitung_keliling)) {
            ...
            KelilingJajarGenjang kelilingJajarGenjang = new KelilingJajarGenjang(sisiAB, sisiBC, sisiCD, sisiAD);
            txtHasil.setText(String.valueOf("Hasil (Result)\nKeliling:\n" + kelilingJajarGenjang.hitung_keliling()));
